...
def select_strategy(
    ...
    return {
        ...
        "selected_by": (
            "population_share"
            if mode == "dominant"
            else ("utility" if mode == "best_utility" else "sampling")
        ),
...
def compact_selection(selection: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
    ...
    return {
        ...
        "population_share": selection["probability"],
        "utility": selection["utility"],
        "current_utility": selection["utility"],
        "mode": selection["mode"],
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--mode", default="dominant", choices=["dominant", "sample", "best_utility"])
