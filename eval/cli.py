...
from eval.runners.run_stage import run_stage
from eval.runners.run_trial import run_trial
from eval.logging_utils import configure_logging
from eval.reports.report_cli import add_build_report_parser, build_report_from_args
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    run_stage_parser.add_argument("--execute-attacker", action=argparse.BooleanOptionalAction, default=None)
    ...
    run_stage_parser.add_argument("--selection-mode", choices=["dominant", "sample", "best_utility"], default=None)
    ...
    run_stage_parser.add_argument("--strict-comparable-strategies", action="store_true")
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.command == "run-trial":
        ...
        payload = run_stage(
            ...
            strict_comparable_strategies=args.strict_comparable_strategies,
        )
